...
Every language-model generation begins from a represented situation: instructions, prior turns, retrieved records, tool results, summaries, and corrections help determine what becomes relevant, sufficient, or actionable. This paper calls that situated condition the \textbf{generative horizon}. When an output is retained as context, memory, policy, evidence, or authorization, one generation can alter the conditions of later interpretation and action. This is \textbf{recursive interpretive conditioning}: the output of one horizon becomes part of another.
